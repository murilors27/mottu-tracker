...
export default function SobreScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <Text style={[styles.paragraph, { color: colors.text }]}>O Mottu Tracker é um aplicativo mobile criado para facilitar a visualização e o cadastro de motos da empresa Mottu, utilizando sensores UWB para localização precisa mesmo em pátios com alta densidade.</Text>
      <Text style={[styles.paragraph, { color: colors.text }]}>O app conta com funcionalidades como cadastro de motos, visualização de motos localizadas, preferências do usuário e armazenamento local utilizando tecnologias como React Native, TypeScript, React Navigation e AsyncStorage.</Text>
      <Text style={[styles.paragraph, { color: colors.text }]}>O objetivo foi aplicar os conhecimentos adquiridos em aula no desenvolvimento de um app funcional, com navegação entre telas, formulário com manipulação de estado e dados persistentes.</Text>
